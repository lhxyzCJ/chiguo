...
# Core tests (full suite: 58 py + 13 script standalone runners)
...
- **Run the full suite before submitting**: see `AGENTS.md` (58 py + 13 script tests), all green before commit.
