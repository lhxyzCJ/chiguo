...
# Core tests (full suite: 37 py + 10 script standalone runners)
...
- **Run the full suite before submitting**: see `AGENTS.md` (37 py + 10 script tests), all green before commit.
