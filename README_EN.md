...
# Core tests (full suite: 44 py + 10 script standalone runners)
...
- **Run the full suite before submitting**: see `AGENTS.md` (44 py + 10 script tests), all green before commit.
