...
# Core tests (full suite: 43 py + 10 script standalone runners)
...
- **Run the full suite before submitting**: see `AGENTS.md` (43 py + 10 script tests), all green before commit.
