...
# Core tests (full suite: 53 py + 13 script standalone runners)
...
- **Run the full suite before submitting**: see `AGENTS.md` (53 py + 13 script tests), all green before commit.
