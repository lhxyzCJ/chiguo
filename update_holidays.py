...
# ═══════════════════════════════════════════════════════════
# 24 节气（单一事实源 · 天文权威校准）
# 数据来源：香港天文台（HKO）公历农历对照表 + 独立太阳黄经复盘
#   （2026-08-15 校准，GitHub #259）。日期按北京时间（UTC+8）归日。
...
# (name, month, day) — 2026 天文权威校准（HKO：雨水 02-18、大暑 07-23、冬至 12-22）
SOLAR_TERMS_2026 = [
...
# (name, month, day) — 2027 天文权威校准（HKO：立夏 05-06、立秋 08-08；
