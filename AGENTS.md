...
```bash
node test_pi_run.mjs && node test_trigger_script.js && bash test_install_integration.sh && bash test_wechat_bridge.sh && \
...
uv run python test_envcheck.py   # full suite (19 py + 4 script tests)
