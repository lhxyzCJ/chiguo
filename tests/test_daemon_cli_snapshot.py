...
EXPECTED = {
    ...
    "send_status":     dict(type="str", default=None, nargs=None, const=None, choices=["success", "failed", "uncertain"], metavar=None),
...
HELP_SNAPSHOT = {
    ...
    "send_result": "回传发送结果 (配合 --send-status success|failed|uncertain, 可选 --error)",
