...
if __name__ == "__main__":
    ...
    test_tracker_recompute_success()
    test_tracker_record_roundtrip()
    test_tie_break_smallest_width()
    test_corrupt_state_does_not_crash()
    test_state_records_and_persists_circadian()
    test_quiet_window_uses_learned_window_when_confident()
    test_quiet_window_falls_back_when_not_confident()
    test_state_old_version_without_circadian_loads()
    test_can_send_respects_learned_window()
    test_min_confidence_activates_at_min_sample_days()
    test_bucket_for()
    test_track_reply_hour_dual_bucket()
    test_aggregate_count_bucket_filter()
    ...
    test_migrate_v7_state_backfills_buckets_and_weekday_window()
    test_migrate_does_not_inherit_weekend_snapshot_into_weekday()
    test_sync_quiet_window_selects_bucket_by_now()
    test_sync_quiet_window_falls_back_when_bucket_not_confident()
    test_migrate_v8_uses_holiday_and_makeup_buckets()
    test_sync_quiet_window_type_drift_defensive()
    test_migrate_confidence_type_drift_gate()
