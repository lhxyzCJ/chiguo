...
(
  node tests/test_bridge_askagent_rpc.mjs && node tests/test_bridge_askagent.mjs && node tests/test_bridge_cmd.mjs && node tests/test_cli_dto.mjs && node tests/test_bridge_health.mjs && node tests/test_bridge_send_timeout.mjs && node tests/test_bridge_rotate.mjs && node tests/test_bridge_memory_rpc.mjs
) & _pid_b=$!
(
  _inner_fail=0
